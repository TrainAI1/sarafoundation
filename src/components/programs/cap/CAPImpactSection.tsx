    ...
    <section className="py-16 md:py-24 bg-primary/5">
      <div className="section-container">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16 px-4">
          <span className="section-badge mb-4 md:mb-6">CAP Impact</span>
          <h2 className="section-title text-foreground mb-4 md:mb-6">
            Access provided. <span className="gradient-text">Learning delivered.</span>
          </h2>
          <p className="section-subtitle mx-auto">
            Each figure measures a different thing. Learners, sessions, attendances and projects are counted
            separately and are not unique individuals.
          </p>
        </div>
