...
import { Plus, Trash2, Save, MessageSquare, Star } from "lucide-react";
...
const defaultTestimonials: Testimonial[] = [
  { id: 1, name: "Taiwo", role: "Full-Stack Developer", program: "CAP Tech Hub FUOYE, Nigeria", quote: "My journey with CAP Tech Hub as a Full-Stack Developer has been incredibly transformative.", rating: 5 },
  { id: 2, name: "Abubakar Samuel", role: "Engineering Student", program: "CAP Tech Hub Global, Togo", quote: "The CAP Tech Hub program has been an incredible journey for me.", rating: 5 },
  { id: 3, name: "Olamide Fasoranti", role: "UI/UX Designer", program: "FLIP Fellow, Cohort 1", quote: "The FLIP Fellowship challenged me to think differently about problem-solving.", rating: 5 },
  { id: 4, name: "Fathia", role: "200L Student, University of Ibadan", program: "CAP Tech Hub Cohort 2", quote: "Every expert session opened my eyes to something new.", rating: 5 },
];
...
export default function AdminTestimonials() {
  ...
  const addNew = () => {
    ...
    const newTestimonial: Testimonial = { id: newId, name: "", role: "", program: "", quote: "", rating: 5 };
  ...
  const save = () => {
    toast.success("Testimonials saved! (Note: These are currently stored locally. Database integration coming soon.)");
    setEditing(null);
  };
    ...
    <div>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Manage success stories displayed on the website.</p>
        </div>
        ...
        {testimonials.map((t) => (
          <div key={t.id} className="card-modern overflow-hidden">
            <div className="p-3 md:p-4 flex items-start justify-between gap-3">
              <div className="flex-1 min-w-0" onClick={() => setEditing(editing === t.id ? null : t.id)}>
      ...
      <div className="mt-4">
        <Button onClick={save}><Save className="w-4 h-4 mr-2" /> Save All Testimonials</Button>
      </div>
    </div>
  );
}
