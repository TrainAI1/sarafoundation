...
const defaultPages = [
  ...
  { slug: "programs-cap", title: "Programs – CAP", icon: GraduationCap, previewPath: "/programs/cap", fields: [
    { key: "hero_headline", label: "Hero Headline", type: "text", placeholder: "Community Access & Participation Pathway" },
  ...
  { slug: "programs-flip", title: "Programs – FLIP", icon: Heart, previewPath: "/programs/flip", fields: [
    { key: "hero_headline", label: "Hero Headline", type: "text", placeholder: "Female Learning & Inclusion Pathway" },
