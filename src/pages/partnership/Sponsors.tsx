      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="section-container">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="overflow-x-auto pb-4 -mx-4 px-4">
              <div className="flex gap-4" style={{ minWidth: 'max-content' }}>
                {currentSponsors.map((sponsor) => (
                  <div key={sponsor.name} className="flex-shrink-0 w-[200px] md:w-[240px] p-4 md:p-5 rounded-xl bg-card border border-border/50 hover:border-primary/30 hover:shadow-md transition-all text-center">
            ...
            <p className="text-center text-muted-foreground text-xs mt-3">Scroll horizontally to see all {currentSponsors.length} sponsors and partners →</p>
          </div>
        </div>
      </section>
