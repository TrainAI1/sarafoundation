  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta name="description" content="CAP expands access to structured digital education, mentoring and practical learning for young people from underserved and underrepresented communities in Africa." />
        ...
        <meta property="og:description" content="CAP expands access to structured digital education, mentoring and practical learning for young people from underserved and underrepresented communities in Africa." />
        ...
        <meta name="twitter:description" content="CAP expands access to structured digital education, mentoring and practical learning for young people from underserved and underrepresented communities in Africa." />
