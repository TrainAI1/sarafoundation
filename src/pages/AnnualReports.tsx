...
const reports = [
  {
    ...
    summary: "763+ students trained across 35+ universities in 8 African countries, the launch of the FLIP Fellowship, expanded WPTA and WFTA communities, and our first Government Job Placement cohort.",
